  ...
  return (
        <Card className={className}>
            ...
            >
                ...
                <LazyImage src={siteInfo?.icon} className='rounded-full' width={120} alt={siteConfig('AUTHOR')} style={{ width:'70px', filter: blur('0px'),'margin-top':'-1rem','margin-right': '1.5rem'}}/>
            </div>
