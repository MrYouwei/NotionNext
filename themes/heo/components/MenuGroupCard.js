          ...
          return (
            <div key={index} className=''>
              <Link
                ...
                target={link?.target}
                className={
                  'w-full flex items-center justify-between py-5 hover:scale-105 duration-200 transform dark:hover:text-indigo-400 hover:text-indigo-600 px-2 cursor-pointer'
                }>
                <>
                  <div>{link.name} :</div>
